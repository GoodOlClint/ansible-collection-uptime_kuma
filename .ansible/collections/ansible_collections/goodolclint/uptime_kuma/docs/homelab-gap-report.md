...
Date: 2026-08-23. Sources: `~/Source/homelab` (`docs/uptime-kuma-monitors.md`, ADR 0011, `docs/ansible-collection-modernization-review.md`, `docs/rebuild-as-routine-design.md`, `scripts/seed_uptime_kuma.py`, `network-data/uptime-kuma-monitors.example.json`, `ansible/roles/monitoring/`), this repo at `origin/main` (PR #2 merged), and a live probe of the instance at `172.16.40.103:3001`.
